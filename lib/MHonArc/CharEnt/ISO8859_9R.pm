##---------------------------------------------------------------------------##
##  File:
##      $Id: ISO8859_9R.pm,v 1.1 2001/08/19 09:53:56 ehood Exp $
##  Author:
...
package MHonArc::CharEnt::ISO8859_9R;
...
+{
  ...
  #--------------------------------------------------------------------------
    ...
    'Iuml'	=> 0xCF,	# ISOlat1: LATIN CAPITAL LETTER I WITH
				#	   DIAERESIS
    'Gbreve'	=> 0xD0,	# ISOlat2: LATIN CAPITAL LETTER G WITH BREVE
    ...
    'Uuml'	=> 0xDC,	# ISOlat1: LATIN CAPITAL LETTER U WITH
				#	   DIAERESIS
    'Idot'	=> 0xDD,	# ISOlat2: LATIN CAPITAL LETTER I WITH DOT
				#	   ABOVE
    'Scedil'	=> 0xDE,	# ISOlat2: LATIN CAPITAL LETTER S WITH CEDILLA
    ...
    'imacr'	=> 0xEF,	# ISOlat2: LATIN SMALL LETTER I WITH MACRON
    'gbreve'	=> 0xF0,	# ISOlat2: LATIN SMALL LETTER G WITH BREVE
    ...
    'divide'	=> 0xF7,	# ISOlat1: DIVISION SIGN
    ...
    'inodot'	=> 0xFD,	# ISOlat2: LATIN SMALL LETTER I DOTLESS
    'scedil'	=> 0xFE,	# ISOlat2: LATIN SMALL LETTER S WITH CEDILLA
